...
namespace ProjectS4API.Data.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "Evaluation_Characteristics",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Evaluation_Characteristics", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvalCharsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Exams_Evaluation_Characteristics_EvalCharsId",
                        column: x => x.EvalCharsId,
                        principalTable: "Evaluation_Characteristics",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ongoing_Evaluations_Evaluation_Characteristics_EvalCharsId",
                        column: x => x.EvalCharsId,
                        principalTable: "Evaluation_Characteristics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ongoing_Evaluations_EvalCharsId",
                table: "Ongoing_Evaluations",
                column: "EvalCharsId");
